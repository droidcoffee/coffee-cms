			...
			<table width="100%" class="pn-ftable" cellpadding="2" cellspacing="1"
				...
				<tr>
					...
					<td colspan="3" class="pn-fcontent">
						<input type="text" maxlength="150" name="pname" class="required" size="70" maxlength="150" />
					</td>
				</tr>
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
					...
					<td colspan="3" class="pn-fcontent">
						<input type="text" maxlength="150" name="lat" class="required" size="70" maxlength="150" />
					</td>
				</tr>
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
					...
					<td colspan="3" class="pn-fcontent">
						<input type="text" maxlength="150" name="lon" class="required" size="70" maxlength="150" />
					</td>
				</tr>
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
					...
					<td colspan="3" class="pn-fcontent">
						<input type="text" maxlength="150" name="visible" value="0" class="required" size="70" maxlength="150" />
					</td>
				</tr>
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
					...
					<td colspan="3" class="pn-fcontent">
						<input type="text" maxlength="150" name="location" class="required" size="70" maxlength="150" />
					</td>
				</tr>
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
					...
					<td colspan="3" class="pn-fcontent">
						<input type="text" maxlength="150" name="phone" class="required" size="70" maxlength="150" />
					</td>
				</tr>
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
					...
					<td colspan="3" class="pn-fcontent">
						<input type="text" maxlength="150" name="remark" class="required" size="70" maxlength="150" />
					</td>
				</tr>
				<tr>
