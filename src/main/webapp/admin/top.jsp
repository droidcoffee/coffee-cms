...
<%
	...
	{
		session.setAttribute(Constants.KEY_SESSION_USER, null);
             ...
             <div class="login-welcome">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                       <tr>
                         ...
                         <img src="${path}/res/img/admin/welconlogin-icon.png"/>
                         <span id="welcome">您好, ${user.uname}
                          </span>
                         <img src="${path}/res/img/admin/loginout-icon.png"/><a href="top.jsp?action=logout" target="_top" id="logout" onclick="return confirm('您确定退出吗？');">退出</a>　　
                         </td>
                         <td align="right">
             ...
             <div class="nav">
             	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td>
                        	<ul class="nav-menu">
                            	<li class="current" id="tb_1" onclick="hoverLi(1,1);">
