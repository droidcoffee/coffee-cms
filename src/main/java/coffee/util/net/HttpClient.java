...
public class HttpClient {
	...
	public static String openConnection(String linkUrl, int tryCount) {
		...
		try {
			...
			if(linkUrl.startsWith("https://")){
				docHtml = SSLTrustManager.openConnection(linkUrl);
			}else{
	...
	public static void main(String[] args) {
		openConnection(
				"https://graph.qq.com/oauth2.0/token?grant_type=authorization_code&client_id=100431420&client_secret=55ebaea63e4a132b26923bfa4d018255&redirect_uri=http://www.droidcoffee.com/coffee/qqauth&code=87DD2675D2C60F4B3111B866AD27CE47",
				1);
	}
