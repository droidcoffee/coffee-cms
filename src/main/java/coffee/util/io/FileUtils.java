...
public class FileUtils {
	...
	public static String getProjectBasePath() {
		// /usr/local/tomcat/apache-tomcat-7.0.33/webapps/droidcoffee/WEB-INF/classes/
		File file = new File(FileUtils.class.getClassLoader().getResource("/")
				.getFile());
